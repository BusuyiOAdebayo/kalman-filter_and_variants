...
initX = [2.5; 5; 0; 0.15; 0.08]; %Initial state (Biomass, Glucose, Ethanol)
initP = diag([0.1, 0.02, 0.02, 0.2, 0.02]); % Initial process estimation covariance matrix
...
Q = diag([0.001, 0.001, 0.001, 0.001, 0.001]); % Process noise covariance matrix;
